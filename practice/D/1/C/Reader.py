...
class Reader(Person):
    def __init__(self, first_name, last_name, age, card_number, card={}):
        ...
        self.card = card
        Logger.log(Logger.LogKey.CRE, "Reader: создан экземпляр")

    def add_book(self, book_number, date):
        self.card[book_number] = date
        Logger.log(Logger.LogKey.INF, "Reader: добавлена книга")
    ...
    def get_book_date(self, book_number):
        try:
            ...
            Logger.log(
                Logger.LogKey.ERR, "Reader: get_book_date: книга не найдена"
            )
